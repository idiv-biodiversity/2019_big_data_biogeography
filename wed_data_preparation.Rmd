...
2. Use the cleaned occurrences together with the taxon specific bioregionalization to get a species to area classifcation in the right format to use for the DEC analysis. If you do not have suitable bioregions, use biome classifications instead.
...
# load bioregions
area <- readOGR(dsn = "example_data", layer = "bombacoideae_bioregions")

# Classify species
class <- SpGeoCod(x = occ, y = area, areanames = "bioregio")
